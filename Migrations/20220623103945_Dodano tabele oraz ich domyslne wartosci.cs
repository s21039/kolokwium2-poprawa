...
{
    public partial class Dodanotabeleorazichdomyslnewartosci : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Google.com", "Google" });

            migrationBuilder.InsertData(
                table: "Member",
                columns: new[] { "MemberID", "MemberName", "MemberNickName", "MemberSurname", "OrganizationID" },
                values: new object[] { 1, "John", "jdoe", "Doe", 1 });

            migrationBuilder.InsertData(
                table: "Team",
                columns: new[] { "TeamID", "OrganizationID", "TeamDescription", "TeamName" },
                values: new object[] { 1, 1, "Developing products", "Software engineers" });

            migrationBuilder.InsertData(
                table: "File",
                columns: new[] { "FileID", "FileExtension", "FileName", "FileSize", "TeamID" },
                values: new object[] { 1, "sln", "Solution", 1024, 1 });

            migrationBuilder.InsertData(
                table: "Membership",
                columns: new[] { "MemberID", "TeamID", "MembershipDate" },
                values: new object[] { 1, 1, new DateTime(2022, 6, 6, 0, 0, 0, 0, DateTimeKind.Unspecified) });
